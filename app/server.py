...
GLOBAL_CONFIG = {
    "model": {
        ...
        "classifier": {
            "serialized_model_path": "/workspace/corise-mlops-wk3/data/news_classifier.joblib"
        }
    },
    "service": {
...
class NewsCategoryClassifier:
    ...
    def predict_proba(self, model_input: dict) -> dict:
        ...
        classes_to_prob = dict(zip(self.classes, predictions[0].to_list()))
        return classes_to_prob
